...
public class EvolutionRabbit{
	...
	// Params
	final double performanceGoal = 500;
	...
	public EvolutionRabbit(){
		...
		while(true){
			...
			boolean goal = performance >= performanceGoal;
			...
			System.out.println("Max Performance: " + population.get(population.size() - 1).score);
			...
			int totalChosen = 0;
			for(int j = 0; j < initPopSize / reproductionFactor; j++){
